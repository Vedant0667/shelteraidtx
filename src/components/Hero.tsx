  ...
  return (
    <section id="hero" className="relative w-full overflow-hidden min-h-screen flex items-center">
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-20 sm:py-28 w-full">
        ...
        >
          <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-tight text-slate-900">
          ...
          <div className="mt-8 flex flex-wrap gap-4 justify-center">
            <Link
              href="/get-involved"
              className="inline-flex items-center rounded-full px-8 py-4 text-lg font-semibold text-white transition-opacity hover:opacity-90"
              style={{
